...
The input contains multiple test cases. Each test case consists of two lines. The first line contains two integers n and m (1 ¡Ü n ¡Ü 100, 1 ¡Ü m ¡Ü 106). The second lines contains n integers a1, a2, ¡­, an (1 ¡Ü a1, a2, ¡­, an ¡Ü 105). For each 1 ¡Ü i ¡Ü n, there are ai disks of size i. The input ends where EOF is met.
